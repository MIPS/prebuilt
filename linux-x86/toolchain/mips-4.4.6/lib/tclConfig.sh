...
# installed.
TCL_PREFIX='/home/fu/dev/gcc44/build-linux-20110223/tools'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/fu/dev/gcc44/build-linux-20110223/tools'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/fu/dev/gcc44/build-linux-20110223/obj/binutils/tcl/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/fu/dev/gcc44/build-linux-20110223/tools/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/fu/dev/gcc44/build-linux-20110223/tools/include'
...
# compiled.
TCL_SRC_DIR='/home/fu/dev/gcc45/src/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/fu/dev/gcc44/build-linux-20110223/tools/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/fu/dev/gcc44/build-linux-20110223/obj/binutils/tcl/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/fu/dev/gcc44/build-linux-20110223/tools/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/fu/dev/gcc44/build-linux-20110223/obj/binutils/tcl/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/fu/dev/gcc44/build-linux-20110223/tools/lib/libtclstub8.4${TCL_DBGX}.a'
